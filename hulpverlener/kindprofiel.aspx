<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="kindprofiel.aspx.cs" Inherits="hulpverlener_kindprofiel" %>
            ...
            <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="false">
                <Columns>
                    <asp:TemplateField HeaderText="Profiel foto">                   
                        <ItemTemplate>
                            <asp:Image ID="ImageName" ImageUrl='<%# "TKINHandler.ashx?ProfielFotoId="+ Eval("ProfielFotoId") %>' runat="server"
