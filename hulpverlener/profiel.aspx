<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="profiel.aspx.cs" Inherits="hulpverlener_profiel" %>
            ...
            <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="false">
                <Columns>
                    <asp:TemplateField HeaderText="Profiel foto">                   
                        <ItemTemplate>
                            <asp:Image ID="ImageName" ImageUrl='<%# "THULHandler.ashx?ProfielFotoId="+ Eval("ProfielFotoId") %>' runat="server"
                ...
                <tbody>
                  ...
                  <img class="editpijltje" src="../images/pencil-icon.png" alt="edit pencile" /></td></tr>-->
                   ...
                   <img class="editpijltje" src="../images/pencil-icon.png" alt="edit pencile" /></td></tr>-->
                    ...
                    <asp:HiddenField ID="HulpId" runat="server" Value="" />
                    <tr><td>
